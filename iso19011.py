...
class MapaMental:
    def __init__(self, root):
        ...
        self.conceptos = {
            0: [
                {"titulo": "Concepto A", "texto": "Explicación del Concepto A"},
                {"titulo": "Concepto B", "texto": "Explicación del Concepto B"},
                {"titulo": "Concepto C", "texto": "Explicación del Concepto C"}
            ],
            1: [
                {"titulo": "Subconcepto A1", "texto": "Explicación del Subconcepto A1"},
                {"titulo": "Subconcepto A2", "texto": "Explicación del Subconcepto A2"}
            ],
            2: [
                {"titulo": "Subconcepto B1", "texto": "Explicación del Subconcepto B1"},
                {"titulo": "Subconcepto B2", "texto": "Explicación del Subconcepto B2"}
            ],
            3: [
                {"titulo": "Subconcepto C1", "texto": "Explicación del Subconcepto C1"},
                {"titulo": "Subconcepto C2", "texto": "Explicación del Subconcepto C2"}
            ]
        }
    ...
    def crear_interfaz(self):
        ...
        for i, concepto in enumerate(self.conceptos[self.current_level]):
            boton = tk.Button(
                ...
                command=lambda c=concepto: self.mostrar_explicacion(c)
            )
    ...
    def mostrar_explicacion(self, concepto):
        """Muestra el texto explicativo del concepto seleccionado."""
    ...
    def volver_atras(self):
        """Vuelve al nivel anterior del mapa mental."""
        if self.current_level > 0:
